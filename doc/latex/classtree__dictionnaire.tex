...
Ajoute la chaîne mot au dictionnaire, avec la valeur v, mot étant supposé absent du dictionnaire. O(n$\ast$log(n)) 
...
Associe la valeur v à la chaîne mot dans le dictionnaire, mot pouvant être présent ou absent du dictionnaire. O(n$\ast$log(n)) 
...
Teste si le dictionnaire contient un mot. O(n$\ast$log(n)) 
...
Supprime l'éventuelle chaîne mot du dictionnaire. O(n$\ast$log(n)) 
...
Donne la valeur correspondant à la chaîne mot (supposée figurer dans le dictionnaire). O(n$\ast$log(n)) 
